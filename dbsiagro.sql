...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-12-2015 a las 23:16:07
...
ALTER TABLE `spactividad`
 ADD PRIMARY KEY (`pkActividad`), ADD KEY `fkOrdenTrabajo` (`fkOrdenTrabajo`);
...
ALTER TABLE `spequipo`
 ADD PRIMARY KEY (`pkEquipo`), ADD UNIQUE KEY `codigo` (`codigo`), ADD KEY `fkTipoEquipo` (`fkTipoEquipo`), ADD KEY `fkModelo` (`fkModelo`), ADD KEY `fkOrdenTrabajo` (`fkOrdenTrabajo`);
...
--
ALTER TABLE `spimproductiva`
MODIFY `pkImproductiva` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
